# Just fork from [@zeit/next-css](https://github.com/zeit/next-plugins/tree/master/packages/next-css)

# Next.js + CSS

Import `.css` or `.pcss` files in your Next.js project

## Installation

```
npm install --save-dev next-pcss
```

or

```
yarn add -D next-pcss
```
...
```js
// next.config.js
const withCSS = require('next-pcss')
